...
SET(CONTRIB_NAME "opencv4_contrib")
...
SET(OPENCV_SRC_PATH "opencv4_src")
SET(OPENCV_BUILD_PATH "opencv4_build")
ExternalProject_Add(opencv4_src
  ...
  CONFIGURE_COMMAND cd ../${OPENCV_BUILD_PATH} && cmake
    ...
    -DOPENCV_GENERATE_PKGCONFIG=ON # Generate pkgconfig file opencv4.pc
